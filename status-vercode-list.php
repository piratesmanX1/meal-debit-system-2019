...
<!--===============================================================================================-->
 ...
 <div class="row x_title">
   <div class="col-md-6">
     ...
     echo ' Status </small></h3>
   </div>
 </div>
 <div class="row x_title">
   <div class="col-md-6">
     <h3>Active Codes <small>';
     echo '</small></h3>
   </div>
 						...
 						<table class="reg-table">
 							<thead>
 								<tr class="row100 head">
 									...
 									<th class="cell100 column5">Active</th>
 								</tr>
 							</thead>
 						</table>
 					</div>
                  ...
                  while ($row = $result->fetch_assoc()) {
                    ...
                    <tr class="row100 body">
                      ...
                      <td class="cell100 column5 reg-table-td" style="min-width:100%; min-height:100%;"> ';
                        if ($row["code_active"] == 0) {
                          echo "N";
                        } else if ($row["code_active"] == 1) {
                          echo "Y";
                        } else {
                          echo "-";
                        }
...
';
 ...
 $TOTVERI = "SELECT COUNT(*) AS TOTAL_VERI FROM verification_code
            WHERE code_active = '0'";
 $TOTVERIQ = mysqli_query($con, $TOTVERI);
 if (mysqli_num_rows($TOTVERIQ) < 1) {
   // only 1 page needed //
   $total_veri = "1";
 } else {
   // count how many pages are needed //
   if ($row = mysqli_fetch_array($TOTVERIQ)) {
     $total_veri = $row["TOTAL_VERI"];
     // then we divide the number of total verification codes record by 10, then round up, i.e. 1.1 > 2; since any extra records will required 1 new page //
     $total_veri = ($total_veri / 10);
     $total_veri = ceil($total_veri);
   }
 }
// now checking which category got the highest value //
if ($total_vera > $total_veri) {
  $page_numb = $total_vera;
} else if ($total_vera < $total_veri) {
  $page_numb = $total_veri;
} else {
 ...
 echo '<div class="center">
      <div class="pagination" id="page-div">
        <a class="page" onclick="verTableS(this)" name="table-page" value="';
        ...
        echo '" id="page-'.$previous_page.'">&laquo;</a>
          ...
          echo '" onclick="verTableS(this)" name="table-page" id="page-1" value="1"> 1 </a>';
 for ($n = 2; $n <= $page_numb; $n++) {
   ...
   echo '" onclick="verTableS(this)" name="table-page" id="page-'.$n.'" value="'.$n.'">'.$n.'</a>';
 }
 echo '<a class="page" name="table-page" onclick="verTableS(this)" value="';
 ...
 echo '" id="page-'.$next_page.'">&raquo;</a>
  ...
  <div class="">
    <div class="logmod__container">
      ...
      <div class="logmod__tab lgm-1 show" id="ver-form-dis">
        ...
        <div class="logmod__form">
            ...
            <div class="simform__actions">
              <input disabled class="sumbit" name="submit-list-disA" style="font-family:oswald!important;" type="submit" id="submit-dis" value="Confirm Removal" />
      ...
      <form method="POST" action="">
        <div class="logmod__heading">
          <span class="logmod__heading-subtitle">Enter your information to verify and <strong>enable the code.</strong></span>
        </div>
        <div class="logmod__form">
            <div class="sminputs">
              <div class="input full">
            ...
            <div class="simform__actions">
              <input disabled class="sumbit" name="submit-list-enableS" style="font-family:oswald!important;" type="submit" id="submit-res" value="Enable Code" />
              <div id="error-message-res" style="font-size:17px;"></div>
              <span class="simform__actions-sidetext">By enabling the verification code, you are here and agree our <a class="special" onclick="return false;" role="link">Terms & Conditions</a></span>
            </div>
        </div>
       </div>
